...
//    detect_handle = osThreadCreate(osThread(DETECT), NULL);
    ...
    osThreadDef(jointmotor,jointmotor_task,osPriorityAboveNormal,0,256);
		jointmotor_handle = osThreadCreate(osThread(jointmotor),NULL);
