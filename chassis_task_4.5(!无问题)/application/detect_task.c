...
static void detect_init(uint32_t time)
{
    ...
    uint16_t set_item[ERROR_LIST_LENGHT][3] =
        {
            {30, 40, 15},   //DBUS
            {20, 30, 11},   //joint_motor1
            {20, 30, 10},   //joint_motor2
            {20, 30, 9},    //joint_motor3
            {20, 30, 8},    //joint_motor4
            {2, 3, 14},     //chassis_motor1
            {2, 3, 13},     //chassis_motor2
            {2, 3, 7},      //board gyro
            {5, 5, 7},      //board accel
            {40, 200, 7},   //board mag
        };
