...
#define PITCH_SPEED_PID_KP       2175.0f//2000.0f
#define PITCH_SPEED_PID_KI        0.0f   //0
...
#define YAW_SPEED_PID_KP        5000.0f   //ma  3600f
...
#define PITCH_GYRO_ABSOLUTE_PID_KP 35.0f//15
#define PITCH_GYRO_ABSOLUTE_PID_KI 0.0f
#define PITCH_GYRO_ABSOLUTE_PID_KD 2.0f
...
#define YAW_GYRO_ABSOLUTE_PID_MAX_IOUT  5.0f

//pitch encode angle close-loop PID params, max out and max iout
//pitch 角度环 角度由编码器 PID参数以及 PID最大输出，积分输出
#define PITCH_ENCODE_RELATIVE_PID_KP 100.0f     //100.0f
...
//turn speed
//掉头云台速度
#define TURN_SPEED 0.0045f //  0.04f//0.01
//测试按键尚未使用
...
#define YAW_RC_SEN    -0.000004f     //遥控器yaw轴输入值缩放系数  可以调灵敏度的
#define PITCH_RC_SEN  0.00001f //0.005   //pitch轴输入值缩放系数 + 是正方向 - 是负方向

#define YAW_MOUSE_SEN   0.00001f// 0.00005f
#define PITCH_MOUSE_SEN 0.000015f  //0.00015f
...
//云台初始化回中值的速度以及控制到的角度
#define GIMBAL_INIT_PITCH_SPEED     0.0005f   //0.004
#define GIMBAL_INIT_YAW_SPEED       0.00025f   //0.005
...
typedef struct
{
	...
	//max是俯角限位值，min是仰角限位值
	fp32 max_software_relative_angle; //rad
    fp32 max_software_relative_angle_xtl; //rad
