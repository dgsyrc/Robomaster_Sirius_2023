...
extern Graph_Data G1,G2,G3,G4,G5,G6,G7,G8,G9,G10,G11;
extern String_Data CH_Pitch,CH_Cap,CH_Rotate,CH_Aim;
extern Float_Data F1_pitch,F2_cap,F3_rotate,F4_aim;
void UI_test(void);
