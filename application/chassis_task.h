...
#define CHASSIS_ANGLE_Z_RC_SEN 0.001f// 0.000002f
...
////底盘旋转
//#define CHASSIS_L_KEY KEY_PRESSED_OFFSET_Q
//#define CHASSIS_R_KEY KEY_PRESSED_OFFSET_E
...
//单个底盘电机最大速度
#define MAX_WHEEL_SPEED 7.5f
//chassis forward or back max speed
//底盘运动过程最大前进速度++++++++++
#define NORMAL_MAX_CHASSIS_SPEED_X 4.5f //2.6//2
//chassis left or right max speed
//底盘运动过程最大平移速度
#define NORMAL_MAX_CHASSIS_SPEED_Y 3.0f  //2
...
//底盘旋转跟随PID
#define CHASSIS_FOLLOW_GIMBAL_PID_KP 40.0f                     //40//22.0f          60
#define CHASSIS_FOLLOW_GIMBAL_PID_KI 2.5f                      //6                  4
#define CHASSIS_FOLLOW_GIMBAL_PID_KD 10.0f                       //                     0
#define CHASSIS_FOLLOW_GIMBAL_PID_MAX_OUT 40.0f                 //9                  40.0
#define CHASSIS_FOLLOW_GIMBAL_PID_MAX_IOUT 0.1f                //0.2                0.01
...
typedef struct
{
  ...
  const power_measure_t *chassis_power_data;
