...
#define INS_INIT_YAW_OFFSET 0.00f
#define INS_INIT_PITCH_OFFSET  0.036f
#define INS_INIT_ROLL_OFFSET  (-0.062f)
...
/**
  ...
  */
/**
  * @brief          获取滤波后的加速度数据,0:x轴, 1:y轴, 2:roll轴 单位 m/s2
  * @param[in]      none
  * @retval         accel_fliter_3的指针
  */
