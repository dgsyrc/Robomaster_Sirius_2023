...
//    osThreadDef(CPXTTask,cpxt_task,osPriorityNormal,0,512);
//    cpxt_task_handle = osThreadCreate(osThread(CPXTTask),NULL);
//      osThreadDef(UITask,ui_task,osPriorityNormal,0,512);
//			ui_task_handle = osThreadCreate(osThread(UITask),NULL);
